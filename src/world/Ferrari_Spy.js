...
export default class Ferrari {
    ...
    this.frontLights.forEach((light, index) => {
      if (this.frontLightFlares[index]) {
        ...
        if (flare1.parent === this.chassis) {
          ...
          const offset1 = new THREE.Vector3(-1.1, -0.3, 2.9); // Forward for front lights
          const offset2 = new THREE.Vector3(1.1, -0.3, 2.9); // Further forward
    ...
    this.brakeLights.forEach((light, index) => {
      if (this.brakeLightFlares[index]) {
        ...
        if (flare1.parent === this.chassis) {
          ...
          // Update both flares with their respective offsets
          const offset1 = new THREE.Vector3(1.2, 0, -3.3);
          const offset2 = new THREE.Vector3(-1.2, 0, -3.3);
  ...
  loadModels() {
    ...
    gltfLoader.load("./car/Ferrari_Spy.glb", (gltf) => {
    ...
    this.wheels = [];
    for (let i = 0; i < 4; i++) {
      gltfLoader.load("./car/Ferrari_Spy_Wheel.glb", (gltf) => {
